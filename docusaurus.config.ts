...
const config: Config = {
  ...
  tagline: 'Documentation platform with integrated admin management',
  ...
  plugins: [
    ...
    [
      path.resolve(__dirname, 'plugins/admin-api'),
      {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Docusaurus Admin Panel. Built with Docusaurus.`,
    },
    prism: {
